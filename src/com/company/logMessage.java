...
/*            //print the message
    ...
    private void parseTimeDate(String date, String time) {
        ...
        //different from format specified in project description
        //Changed the format to match the sample output given in description
    ...
    public boolean equals(logMessage other) {
        ...
        return this.wholeMessage.equalsIgnoreCase(other.wholeMessage);
    }
}
